...
@WebServlet("/servlet4/*")
public class someservlet4 extends HttpServlet implements ServletContextListener {
...
//		
	    ...
	    System.out.println("someservelet4"+json);
	 ...
	 public List<User3> getAllUsers(String id,String townxx,String brgyxx,String yearxx,String monthxx,String dayxx,String crewxx){ 
		   ...
		   Connection dbCon = null;
			...
			String cpz4="WHERE";if(pz1+pz3>=1) {cpz4="AND";};
		       ...
		       xz5=" WHERE CAST(followed AS DATE) BETWEEN '"+startDate+"' AND '"+endDate+"'";  
		       xz6=" AND CAST(c.followed AS DATE) BETWEEN '"+startDate+"' AND '"+endDate+"'";  
