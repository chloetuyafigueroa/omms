...
@WebServlet("/servlet2/*")
public class someservlet2 extends HttpServlet implements ServletContextListener {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    System.out.println("someservlet2"+json);
	 ...
	 public List<User3> getAllUsers(String id,String townxx,String brgyxx,String yearxx,String monthxx,String dayxx,String crewxx){ 
		   ...
		   Connection dbCon = null;
			...
			String cpz4="WHERE";if(pz1+pz3>=1) {cpz4="AND";};
		       ...
		       System.out.println("SELECT DISTINCT ON (UNIQUE_ID) * FROM CONVERTED "
	       				+ xz1 + xz2 + xz3 + xz4
		    ...
		    try {
		      ...
		      //String query3= "SELECT * FROM CONVERTED WHERE CAST(followed AS DATE) BETWEEN '2018-1-29' AND 'NOW()' ORDER BY followed ASC limit 10";
		       ...
		       rs = stmt.executeQuery("SELECT DISTINCT ON (UNIQUE_ID) unique_id,created,followed,followed::TIMESTAMP WITHOUT TIME ZONE followed1,town0,brgy0,assignedto,name,notes,section,equip,actiontaken,status,type,cause,latitude,longitude FROM CONVERTED "
		       				+ xz1 + xz2 + xz3 + xz4
		       ...
		       //dbCon.close();
			         ...
			         System.err.println("Someservlet2-"+ e.getClass().getName()+": "+ e.getMessage() );
			         //System.exit(0);
			      }
			      return userList;
